...
var fName = localStorage.getItem("caseNumber") + "-discharge-notes.pdf";
		...
		<div class="menu-settings">
			<div class="input-group">
				...
				<ul class="list-group">
					...
					<a href="#submenu3" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start" id="notes-container">
						<div class="d-flex w-100 justify-content-start align-items-center">
							<span class="fa fa-user fa-fw mr-3"></span>
		...
		<div class="case-information">
		  <div class="icon-container">
            <div class="exists-cntnr">
				  ...
				  <p style="text-align:center;">Discharge Notes.pdf</p>
				</a>
            </div>
...
document.querySelector('#notes-container').click();
